...
%\fbox{
					  ...
					  \vbox to 1\vsize{%
					    \haut{}{\blurb}{}
					    \vfill
					    \ligne{\textbf{\Large A New Framework for Measuring and Analysing Argumentation-Based Negotiation }
					 ...
					 %   \vspace{5mm}
					    ...
					    \ligne{%
									      \begin{tabular}{l l}
									        ...
									        Supervisor:&\textsc{\textbf{Dr. Rachida Dssouli }} - CIISE.\\
									        Examiners:&\textsc{\textbf{Dr. A. Ben Hamza}} - CIISE.\\
									        &\textsc{\textbf{Dr. Olga Ormandjieva}} - CSE. \\
									        &\textsc{\textbf{Dr. Roch H. Glitho}} - CIISE \\
									     \end{tabular}
					      }
					          \date{}
					     }
