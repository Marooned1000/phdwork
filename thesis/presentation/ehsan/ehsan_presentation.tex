...
\begin{frame}{Contributions}
    \begin{itemize}     	
        	...
        	\item Proposing a valuation function and a polynomial approximation algorithm for the NP-Hard problem of coalition stability check, making decision making practical in real-time settings for our web service communities.
