...
In next chapter, we analyse the internal community behavior of web services, and propose a model for competing and cooperating agents within the communities of web services.
