...
\begin{figure}%[!t]
\centering
\includegraphics[width=5.5in]{figures/utility_gain.eps}
...
\begin{figure}%[!t]
\centering
\includegraphics[width=5.5in]{figures/utility_ratio.eps}
...
\begin{figure}%[!t]
\centering
\includegraphics[width=5in]{figures/roc.eps}
\caption{RoC Curve}
\label{roc5}
\end{figure}
...
\begin{figure}%[!t]
\centering
\includegraphics[width=5in]{figures/stats1.eps}
...
\begin{figure}%[!t]
\centering
\includegraphics[width=5in]{figures/stats2.eps}
...
\begin{figure}%[!t]
\centering
\includegraphics[width=5in]{figures/stats3.eps}
...
In the next chapter, we analyse the internal community behavior of web services, and propose a model for competing and cooperating agents within the communities of web services.
