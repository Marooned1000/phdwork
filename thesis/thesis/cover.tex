...
\cutitle{Modeling and Verifying Probabilistic Social Commitments in Multi-Agent Systems}

\cudept{Computer Science and Software Engineering}   % your dept.
\cudegree{Doctor of Philosophy}           % your expected degree <-,
\cudegreeshort{Ph.~D.}
\culname{Sultan}                    % your family name
\cufname{Khalid Ibrahim}                    % your given name

\cusupervisor{Dr. Jamal Bentahar}        % your Big-Boss complete name
%\cucosupervisor{Dr. }   % your small big-boss name
\cuexaminerA{Dr. Olga Ormandjieva}
\cuexaminerB{Dr. Rachida Dssouli}
\cuexaminerC{Dr. Abdessamad Ben Hamza}
%\cuexaminerA{}
\cuextexaminer{Dr. Elhadi Shakshuki}     % Another of the previous kind

\cuchair{Dr. G\"osta Grahne}           % the boss of your boss

\cumonth{January}                % the month you expected to graduate
