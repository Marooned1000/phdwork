...
\begin{enumerate}
	...
	\item The solutions propose complex algorithms \cite{DBLP:conf/IEEEscc/LimTMB12, 10.1109/TSC.2012.12, 10.1109/TSC.2014.2312940} to find the optimal strategy, for each time services or communities adopt an strategy. Or the problem is reduced by eliminating important parameters.
\end{enumerate}
