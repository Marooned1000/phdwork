...
Now we want to setup a set of feature vectors representing the communities of web services, for our training purposes. For communities we add two additional external features as discussed in section \ref{s:ef} that reflect the community's estimation of its quality metrics compared to other web services. 
