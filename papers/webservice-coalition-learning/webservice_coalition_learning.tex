...
\title{DLISA: Distributed Learning-based \\ Intelligent Service Agents}
%
%
...
\begin{algorithm}
\DontPrintSemicolon
\KwIn{learning rate $\langle r \rangle$, $|N \times N|$ gain matrix $\langle gain \rangle$, community feature vector $\langle CFVS \rangle$}
\KwOut{A set of \emph{root} nodes of the decision trees}
$k \gets 1$\;
$r \gets initial learning rate$\;
...
\Return{location}\;
\caption{{\sc Tree Creation Algorithm}}
