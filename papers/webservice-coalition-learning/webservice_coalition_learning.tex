...
\title{DDM: Distributed Decision Making Model for Dynamic Formation of Web services Communities}
%
%
%
...
In this section, we first present the architecture of DLISA. We explore the characteristics of intelligent service agents and the features we extract for training. To do this, we first discuss some preliminaries.
...
\subsubsection{Feature Normalization}\label{sss:fn}
...
Now, we evaluate the performance of the strategy profiles generated based on our data set for other communities which are not included in the decision tree creation process. We create one thousand communities out of the web services in the data set that were not involved in the decision model creation process. We define a distance function that measures the difference between basic features of communities.
...
%heading
\hline % inserts single horizontal line
 DLISA r=0.05& 375 \\ % inserting body of the table
 DLISA r=0.07& 137 \\
 DLISA r=0.10& 6 \\
 DLISA r=0.20& 6 \\
Rational Method& 717 \\
