...
ion of web services into communities, would make any brute-force type algorithm for best community selection strategy intractable and non-practical in real-world application settings.
...
We have adopted the web service data set provided by \cite{10.1109/ISSRE.2011.17}.
