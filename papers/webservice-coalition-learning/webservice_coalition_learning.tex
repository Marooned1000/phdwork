...
In this paper, we have implemented [OurMethodName] in which we initially train our services in different possible communities and let them experiment and check the outcome of different scenarios. Based on the trained results these services can be utilized with efficient methods of foreseeing how each of their decisions would impact their long term and short term goals, therefore opting for best decision available. Having a set of web services with pre-defined set of features, we let web services evaluate performance collaborating with a small subset of other web services. Each web service individually will be utilized with knowledge of collaborating with web services having different set of feature values. By deploying a linear distant function, the web services will be able to predict the outcome of collaborating with different web services which may not have been collaborated in during training process. 
