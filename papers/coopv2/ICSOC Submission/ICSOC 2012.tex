...
web services' overall budget. %Before conducting the simulation, the
...
application is written in \textit{C\#} using \textit{Visual Studio}. Developed web services are initialized with values taken
...
competitive strategy, it will fail to get a task. This kind of
...
\begin{figure}%[h]
\centering
\includegraphics[scale=0.33]{Graph2.eps}
