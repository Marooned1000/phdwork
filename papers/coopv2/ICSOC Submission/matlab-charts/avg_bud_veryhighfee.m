[v,T,vT]=xlsread('avg_bud_veryhighfee.xlsx') 
% 'xlsx' for exell 2007
%v: Double
%T and vT : cell
...
title('Very High Membership Fee', 'fontsize', 14);
xlabel({'Number of Runs';'(c)'}, 'FontSize',14);
ylabel('Budget', 'FontSize', 14, 'FontWeight','bold');
