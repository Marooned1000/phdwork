...
In this scenario, there are is a community controller by a community master web sercice. The community master has a secured request rates $(R_{master})$ from users. 
