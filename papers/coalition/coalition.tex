...
\centering
%\includegraphics[scale=0.6]{graph1Final+.eps}
\includegraphics[scale=0.61]{least_core.eps}
\caption{Part (a): Cumulative number of tasks succesfully done. Part
(b): Average QoS of tasks performed.} \label{performanceall}
\end{figure}
