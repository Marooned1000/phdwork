...
Services are software systems providing a standard way of
interoperability among different applications. They are developed
to continuously and autonomously interact with each other to
...
corresponding formulations and explanations. \textbf{}
...
the two strategies. The simulation application is written in
\textit{C\#} using \textit{Visual Studio}. Developed services are
...
reputation parameter \cite{Bentahar,Rosario,Ruth,Yahyaoui}. In
