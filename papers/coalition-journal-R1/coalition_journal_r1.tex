...
unique manager and communication end point, which is the access point to the community.
...
for engineering task distribution within communities. 
...
$\epsilon$-core} set non-emptiness. The results in Figure
