...
etc. until the algorithm gets interrupted becuase of time constraint. If the algorithm gets intreupted while verification \emph{Depth(n)} conditions, we will have \emph{Depth(n-1)} results.
