...
taxtation method to relax the core condition for more communities to form. 
...
As mentioned in section \ref{s:tax} 

texttext texttexttexttext texttexttexttext texttexttexttext texttext texttext texttext texttext texttext texttext
