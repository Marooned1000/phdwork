...
In the first example, we present a community with $R_C$ of 10, and three web services each having different $QoS$ and $Th_{ws}$ values as listed in table \ref{example_1}. 
